...
Welcome to the Task Management App project! This project is a culmination of my journey through web development, where I applied key skills and concepts to create a functional and dynamic task management application. In this project, I took on the role of a developer responsible for not only identifying and resolving bugs but also implementing new features based on detailed user stories.

My task was to enhance the application by ensuring the seamless management of tasks throughout their lifecycle—from creating and editing tasks to deleting them. I also focused on integrating theme customization, allowing users to switch between dark and light modes, and ensuring all data is stored persistently in localStorage for a smooth user experience. This project showcases my ability to blend debugging with creative coding, demonstrating a practical understanding of real-world software development practices.

The final product is a fully functional task management tool that efficiently handles task details, provides intuitive user interaction, and guarantees data persistence, reflecting a strong command of front-end development principles.

### Loom video: https://www.loom.com/share/a978213abf8c4cef91f71174d753d5ea?sid=a5d78431-f77d-46f8-9b85-e52224daea0c

### Presentation: https://docs.google.com/presentation/d/1gfThjmqDV9vUV-NMbql5If3kXS5sYNrgZLbhum9aHCE/edit?usp=sharing
